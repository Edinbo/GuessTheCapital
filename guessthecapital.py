...
country_capitals = {
    ...
    "South Africa (judiciary)": "Bloemfontein",
    "South Sudan": "Juba",
    "Spain": "Madrid",
    "Sri Lanka": "Colombo",
    "Sudan": "Khartoum",
...
for i in guess_count:
    ...
    if guess.lower() == str(correct_capital).lower():
        ...
        print(f"Sorry, capital of {random_country} was {correct_capital}")
        false_guess += 1


if correct_guess > false_guess:
    print(f"Good job you got \n{correct_guess} answers correct \n{false_guess} answers false.")
